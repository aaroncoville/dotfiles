# aaroncoville does dotfiles - forked from jldeen's repo which was in turn forked from holman's repo

### macOS Configuration
Run the following to configure macOS from scratch...
```
bash <(curl -fsSL https://raw.githubusercontent.com/aaroncoville/dotfiles-1/mac/configure.sh)
```
...
[Fork holman's](https://github.com/holman/dotfiles/fork) or [Fork mine](htps://github.com/aaroncoville/dotfiles/fork), remove what you don't
...
[open an issue](https://github.com/aaroncoville/dotfiles/issues) on this repository
